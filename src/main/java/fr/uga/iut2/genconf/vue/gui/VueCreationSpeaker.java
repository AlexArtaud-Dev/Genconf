...
public class VueCreationSpeaker extends Layout<Communication> {
    /**
     * Creates new form VueCreationUtilisateur
     */
    public VueCreationSpeaker(Controleur controleur, GUI gui) {
    ...
    public void initComponents() {
        ...
        this.inputEmail.setForeground(Color.red);
        ...
        try{
            jLabel5.setText("> " + model.getSession().getConference().getNom());
        ...
        try{
            jLabel6.setText("> " + model.getSession().getNom());
        }catch (Exception e){
        ...
        try{
            jLabel12.setText("> " + model.getSession().getConference().getNom());
        }catch (Exception e){

        }
        jLabel12.addMouseListener(new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent mouseEvent) {
        ...
        jLabel13.setText("Ajouter un speaker");
        ...
        inputEmail.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        inputPrenomSpeaker.setBackground(new java.awt.Color(255, 255, 255));
        inputPrenomSpeaker.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        inputPrenomSpeaker.setForeground(new java.awt.Color(0, 0, 0));
        ...
        validerButton.setBackground(new java.awt.Color(153, 153, 153));
        validerButton.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        validerButton.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void creerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_creerActionPerformed
        NouveauSpeaker infosNouveauSpeaker = new NouveauSpeaker(
                this.inputNomSpeaker.getText().trim().toLowerCase(),
                this.inputPrenomSpeaker.getText().trim(),
                this.inputEmail.getText().trim()
        );
        this.gui.creerSpeaker(model.getSession().getConference().getNom(), model.getSession().getNom(), model.getNom(), Optional.of(infosNouveauSpeaker));
    }

    private void annulerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_annulerActionPerformed
        this.gui.creerSpeaker(model.getSession().getConference().getNom(), model.getSession().getNom(),model.getNom(), Optional.empty());
        controleur.consulterCommunication(model.getSession().getConference().getNom(), model.getSession().getNom(), model.getNom());
